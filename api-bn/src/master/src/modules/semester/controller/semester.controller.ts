...
export class SemesterController {
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const includeAcademicYear = req.query.includeAcademicYear === 'true';
      const data = await this.service.getById(req.params.id as string, includeAcademicYear);
...
export const semesterController = new SemesterController(semesterService);
