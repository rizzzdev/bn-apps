import { MajorStudentRepository, majorStudentRepository } from '../repository';
import { NotFoundError } from '@/errors';
import type { WebhookMajorStudentDto } from '../domain/schemas';

export class MajorStudentService {
  constructor(private repository: MajorStudentRepository) {}
  ...
  async upsertFromWebhook(items: WebhookMajorStudentDto[]) {
    let count = 0;
...
export const majorStudentService = new MajorStudentService(majorStudentRepository);
