import { ClassStudentRepository, classStudentRepository } from '../repository';
import { NotFoundError } from '@/errors';
import type { WebhookClassStudentDto } from '../domain/schemas';

export class ClassStudentService {
  constructor(private repository: ClassStudentRepository) {}
  ...
  async upsertFromWebhook(items: WebhookClassStudentDto[]) {
    let count = 0;
