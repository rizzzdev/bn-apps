import { AcademicYearRepository, academicyearRepository } from '@/modules/academic-year/repository';
import { CreateAcademicYearDto, UpdateAcademicYearDto } from '@/modules/academic-year/domain';
...
export class AcademicYearService {
  ...
  async validateUnique(data: Partial<CreateAcademicYearDto>, excludeId?: string) {
    ...
    if (data.status === 'Aktif') {
      ...
      if (activeExists) throw new BadRequestError('An active academic year already exists');
    }
  }
