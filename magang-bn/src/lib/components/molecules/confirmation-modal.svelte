...
<Modal bind:show {title}>
	<div class="flex flex-col items-center text-center space-y-3 py-3">
		<Icon name={typeConfig[type as ModalType].icon} class="text-lg {typeConfig[type as ModalType].color} drop-shadow-[1px_1px_0px_#0f172a]" />
		<p class="font-mono text-xs font-bold">{message}</p>
	</div>
