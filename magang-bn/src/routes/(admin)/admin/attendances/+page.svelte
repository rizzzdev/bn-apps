...
<svelte:head>
	<title>Rekap Presensi Seluruh Murid | Magang-BN</title>
</svelte:head>

<div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-fade-in-up">
	<div>
		<h2 class="font-headline text-xl font-black uppercase tracking-tight">Rekap Presensi Murid</h2>
		<p class="font-mono text-secondary text-[10px] mt-1">Data absensi harian seluruh peserta magang.</p>
	</div>
</div>
