...
<Modal bind:isOpen={isFormOpen} title={editingId ? 'Edit Jam Pelajaran' : 'Tambah Jam Pelajaran'}>
  <div class="flex flex-col gap-4">
    <div class="flex flex-col gap-2">
      <label class="font-label-caps text-label-caps uppercase text-on-surface-variant" for="name">Nama Jam</label>
      <input
        id="name"
        type="text"
        bind:value={formName}
    ...
    <div class="grid grid-cols-2 gap-3">
      <div class="flex flex-col gap-2">
        <label class="font-label-caps text-label-caps uppercase text-on-surface-variant" for="start-time">Jam Mulai</label>
        <input
          id="start-time"
          type="time"
      ...
      <div class="flex flex-col gap-2">
        <label class="font-label-caps text-label-caps uppercase text-on-surface-variant" for="end-time">Jam Selesai</label>
        <input
          id="end-time"
          type="time"
    ...
    <div class="flex flex-col gap-2">
      <label class="font-label-caps text-label-caps uppercase text-on-surface-variant" for="order">Urutan</label>
      <input
        id="order"
        type="number"
