<script lang="ts">
	...
	const positionClasses = {
		'top-left':
			'-top-10 right-0 after:right-3.5 after:top-full after:border-t-on-background',
...
{#if href}
	<a
		{href}
		class="relative group/tooltip inline-flex items-center justify-center w-11 h-11 neo-border neo-shadow-xs transition-all hover:translate-x-0.5 hover:translate-y-0.5 shrink-0 {variantClasses[
