<script lang="ts">
  ...
  import { PageHeader, Modal, SearchableSelect, TooltipIconButton, TimetableGridTable } from '$lib/components/molecules';
...
<Modal bind:isOpen={isCreateOpen} title="Tambah Jadwal Pelajaran">
  <div class="flex flex-col gap-4 overflow-y-auto max-h-[55vh] pr-1">
    ...
    <div class="flex flex-col gap-1">
      <label class="font-label-caps text-xs uppercase font-bold text-on-surface-variant" for="create-notes">Catatan (opsional)</label>
      <input
        id="create-notes"
        type="text"
