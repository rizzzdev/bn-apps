...
export const classApi = {
	...
	classStudents: {
		list: (page = 1, limit = 10) => getList<ClassStudent>('/academic/class-students', { page, limit }),
		...
		bulkStatus: (ids: string[], status: string) => bulkUpdateStatus('/academic/class-students', ids, status),
		...
		graduate: (data: BulkStudentActionRequest) => bulkAction('/academic/class-students', 'graduate', data)
	}
};
