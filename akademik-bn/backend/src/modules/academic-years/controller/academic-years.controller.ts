...
import { AcademicYearService, academicYearsService } from '@/modules/academic-years/service';
...
export const academicYearController = new AcademicYearController(academicYearsService);
