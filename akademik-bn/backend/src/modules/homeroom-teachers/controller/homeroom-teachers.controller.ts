...
import { HomeroomTeacherService, homeroomTeachersService } from '@/modules/homeroom-teachers/service';
...
export class HomeroomTeacherController {
  ...
  getAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const { data, total } = await this.service.getAll(page, limit, classId, status);
...
export const homeroomTeacherController = new HomeroomTeacherController(homeroomTeachersService);
